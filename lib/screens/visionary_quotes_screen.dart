...
import '../services/visionary_quotes_service.dart';
import '../providers/quote_provider.dart';
import '../widgets/custom_snackbar.dart';

class VisionaryQuotesScreen extends StatefulWidget {
  const VisionaryQuotesScreen({Key? key}) : super(key: key);

  @override
  State<VisionaryQuotesScreen> createState() => _VisionaryQuotesScreenState();
}

class _VisionaryQuotesScreenState extends State<VisionaryQuotesScreen> {
  ...
  void initState() {
    super.initState();
    // Convert VisionaryQuotes to regular Quotes
    List<VisionaryQuote> visionaryQuotes = VisionaryQuotesService.getAllQuotes();
    quotes = visionaryQuotes.map((vq) => Quote(
      text: vq.quote,
      author: vq.author,
      isFavorite: false,
    )).toList();
