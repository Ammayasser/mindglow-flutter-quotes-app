...
import '../services/love_quotes_service.dart';
...
class _LoveQuotesScreenState extends State<LoveQuotesScreen> {
  ...
  void initState() {
    super.initState();
    // Convert LoveQuotes to regular Quotes
    List<LoveQuote> loveQuotes = LoveQuotesService.getAllQuotes();
    quotes = loveQuotes.map((lq) => Quote(
      text: lq.quote,
      author: lq.author,
      isFavorite: false,
    )).toList();
