...
import '../services/purpose_quotes_service.dart';
import '../providers/quote_provider.dart';
import '../widgets/custom_snackbar.dart';

class PurposeQuotesScreen extends StatefulWidget {
  const PurposeQuotesScreen({Key? key}) : super(key: key);

  @override
  State<PurposeQuotesScreen> createState() => _PurposeQuotesScreenState();
}

class _PurposeQuotesScreenState extends State<PurposeQuotesScreen> {
  ...
  void initState() {
    super.initState();
    // Convert PurposeQuotes to regular Quotes
    List<PurposeQuote> purposeQuotes = PurposeQuotesService.getAllQuotes();
    quotes = purposeQuotes.map((pq) => Quote(
      text: pq.quote,
      author: pq.author,
      isFavorite: false,
    )).toList();
