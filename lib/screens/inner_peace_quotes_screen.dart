...
import '../models/inner_peace_quote.dart';
import '../services/inner_peace_quotes_service.dart';
import '../providers/quote_provider.dart';
import '../widgets/custom_snackbar.dart';

class InnerPeaceQuotesScreen extends StatefulWidget {
  const InnerPeaceQuotesScreen({Key? key}) : super(key: key);

  @override
  State<InnerPeaceQuotesScreen> createState() => _InnerPeaceQuotesScreenState();
}

class _InnerPeaceQuotesScreenState extends State<InnerPeaceQuotesScreen> {
  ...
  void initState() {
    super.initState();
    // Convert InnerPeaceQuotes to regular Quotes
    List<InnerPeaceQuote> innerPeaceQuotes = InnerPeaceQuotesService.getAllQuotes();
    quotes = innerPeaceQuotes.map((ipq) => Quote(
      text: ipq.quote,
      author: ipq.author,
      isFavorite: false,
    )).toList();
